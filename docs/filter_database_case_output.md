...
actual f_s roots = [-j0.0365, +j0.9705, -j0.8593, +j0.6845]

actual raw e_w roots = [+0.9526 - j0.4571, +0.1267 + j1.1031, -1.4178 - j0.7437, +1.0976 + j0.0977]
actual reflected e_w roots = [+0.9526 + j0.4571, +0.1267 + j1.1031, -1.4178 + j0.7437, +1.0976 + j0.0977]
...
actual e_s roots = [-0.4571 + j0.9526, -1.1031 + j0.1267, -0.7437 - j1.4178, -0.0977 + j1.0976]
```
