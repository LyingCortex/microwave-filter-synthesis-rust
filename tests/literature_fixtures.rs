use mfs::approx::helpers::{
    cameron_recursive, find_eps, find_p_polynomial, pad_transmission_zeros,
    synthesize_generalized_chebyshev_data,
};
...
fn literature_generalized_fixture_drives_generalized_main_flow() -> Result<()> {
    ...
    assert_eq!(outcome.approximation, mfs::synthesis::ApproximationKind::GeneralizedChebyshev);
